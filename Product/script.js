...
// let products = [...document.querySelectorAll("#product")].map(e => e.innerHTML);
...
const allProducts =[
  {title:`A macro step change inferred`,catagory:`computer`,price:`129.50$`},
  {title:`AI CHIPS WITH MILITARY PRECISION`,catagory:`computer`,price:`100.00$`},
  {title:`Qualcomm, Nvidia with new AI chips`,catagory:`computer`,price:`99.99$`},
  {title:`X8 Wireless Earbuds Touch Key`,catagory:`mobile`,price:`50.00$`},
  {title:`Earbuds for smartphones`,catagory:`mobile`,price:`10.00$`},
  {title:`Precision Crafted for Sound and Beauty`,catagory:`mobile`,price:`200.00$`},
  {title:`White & Decker Microwave Oven 20Ltr (MZ2010P)`,catagory:`home`,price:`499.99$`},
  {title:`23 Ltr Burger Microwave Oven Grill Black`,catagory:`home`,price:`799.99$`},
  {title:`Electrolux SEM-130ESL-B6 Microwave Oven`,catagory:`home`,price:`999.99$`}
]
const descriptions = [`AI chips could play a critical role in economic growth going forward because they will inevitably feature in cars,intelligent; robotics, obviously; and many other technologies.`,
  ...
  `LYMOC X8 Wireless Earbuds Touch Key Bluetooth 5.0 Earphones TWS Headsets Sport HiFi Stereo Handfrees Charger for iPhone Xiaomi`,
